...
1() {
	...
	get_patches_key "gg-photos-rv-beta"
	...
	get_apkpure "com.spot"$j"fy.music" "spot"$j"fy-beta-arm64-v8a" "spot"$j"fy-music-and-podcasts-for-android/com.spot"$j"fy.music"
